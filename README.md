...
The objective of this project is to design, automate, and validate a cloud architecture following Infrastructure-as-Code (IaC) principles while demonstrating practical interaction with AWS services using both the AWS Console, AWS CLI, and Python SDK (Boto3).
The repository is organized to reflect a real-world workflow commonly used by cloud engineers, DevOps teams, and solution architects. Every component has been implemented, tested, and documented to ensure reproducibility and clarity for academic evaluation.
...
Terraform is used to provision networking and foundational AWS components:
...
CloudFormation templates were used to deploy application-level services:
...
A Python Lambda function was created to automatically log every new S3 upload.
